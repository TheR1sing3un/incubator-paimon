...
/**
 * Lumina (DiskANN) implementation of {@link AccelerateIndexProvider}.
 *
 * <p>Discovered via {@link java.util.ServiceLoader} and registered as {@code "lumina"}.
 */
public class LuminaAccelerateIndexProvider implements AccelerateIndexProvider {
    ...
    public AccelerateIndexBuilder createBuilder() {
        return new LuminaAccelerateIndexBuilder();
    }

    @Override
    public AccelerateIndexScanner createScanner() {
        return new LuminaAccelerateIndexScanner();
    }
}
