...
class SnapshotLoader:
    ...
    def load(self) -> Optional[str]:
        ...
        try:
            ...
            # REST server returned 501 (catalog doesn't support version
            # management). Re-raise as NotImplementedError so SnapshotManager
            # can fall back to direct filesystem reads.
