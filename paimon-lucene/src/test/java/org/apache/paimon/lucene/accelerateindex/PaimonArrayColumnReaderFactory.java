 ...
 *
 * <p>Parallel to {@code PaimonVectorColumnReaderFactory} but returns {@link InternalArray} instead
 * of {@code float[]}.
 */
public class PaimonArrayColumnReaderFactory implements ArrayColumnReader.Factory {
    ...
    public PaimonArrayColumnReaderFactory(
        ...
        this.fileMetaMap = buildFileMetaMap(split);
    }

    private static Map<String, DataFileMeta> buildFileMetaMap(DataSplit split) {
