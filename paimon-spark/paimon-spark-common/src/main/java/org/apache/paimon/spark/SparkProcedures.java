...
import org.apache.paimon.spark.procedure.DropExpiredHiveTablesProcedure;
...
import org.apache.paimon.spark.procedure.ExportToHiveProcedure;
...
public class SparkProcedures {
    ...
    private static Map<String, Supplier<ProcedureBuilder>> initProcedureBuilders() {
        ...
        procedureBuilders.put("load_file", LoadFileProcedure::builder);
        procedureBuilders.put("export_csv", ExportCsvProcedure::builder);
        procedureBuilders.put("export_to_hive", ExportToHiveProcedure::builder);
        procedureBuilders.put("drop_expired_hive_tables", DropExpiredHiveTablesProcedure::builder);
